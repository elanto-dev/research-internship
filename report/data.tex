...
The total number of conversations shared across all the sources after duplicates and non-English conversations were removed is 11360. However, after removing duplicate conversations from the entire combined dataset, it leaves us with 10175 conversations, which means that 1185 \linebreak developer-\acrshort{gpt} conversations are shared in multiple locations.
...
To understand the reasons behind unusually long conversations, we manually reviewed 295 conversations that exceeded a predefined length threshold. The most common patterns are summarised below:
